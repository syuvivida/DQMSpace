...
parser.add_argument("-g", "--group",
                    dest="dataset_class", type=str, default="Commissioning22", help="Run class type") 
...
for run in out_runs:
  answer = runregistry.move_runs( options.fromstate, options.tostate, run=run["run_number"] )
