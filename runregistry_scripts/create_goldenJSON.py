...
def get_run_ls( run_in ):
     ...
     lumi_store = []
     omsflags_list = ['beam1_present','beam2_present','beam1_stable','beam2_stable','cms_active','bpix_ready', 'fpix_ready', 'tibtid_ready', 'tecm_ready', 'tecp_ready','tob_ready','ebm_ready','ebp_ready','eem_ready','eep_ready','esm_ready','esp_ready','hbhea_ready','hbheb_ready','hbhec_ready','hf_ready','ho_ready','dtm_ready','dtp_ready','dt0_ready','cscm_ready','cscp_ready']
     rrflags_list = ['tracker-pixel', 'tracker-strip', 'tracker-track', 'ecal-ecal', 'ecal-es', 'hcal-hcal', 'l1t-l1tmu', 'l1t-l1tcalo', 'hlt-hlt', 'egamma-egamma', 'muon-muon', 'jetmet-jetmet']
