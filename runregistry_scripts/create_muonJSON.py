...
def get_run_ls( run_in ):
     ...
     lumi_store = []
     omsflags_list = ['beam1_present','beam2_present','beam1_stable','beam2_stable','cms_active','bpix_ready', 'fpix_ready', 'tibtid_ready', 'tecm_ready', 'tecp_ready','tob_ready','dtm_ready','dtp_ready','dt0_ready','cscm_ready','cscp_ready']
     rrflags_list = ['tracker-pixel', 'tracker-strip', 'tracker-track', 'l1t-l1tmu', 'hlt-hlt', 'muon-muon']
